...
namespace PGCafe.Object {
    ...
    /// <summary>
    /// List with two item. ( just inherit from List&lt;TupleC&lt;T1,T2&gt;&gt; and provide some method to use. )
    /// </summary>
    /// <typeparam name="T1"> type of First item. </typeparam>
    /// <typeparam name="T2"> type of Second item. </typeparam>
    public class List<T1,T2> : List<TupleC<T1,T2>> {
        ...
        public List( IEnumerable<TupleC<T1,T2>> collection ) : base( collection ) { }

        /// <summary>
        /// Add item to list.
        /// ( just call base.Add( TupleC.Create( item1, item2 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to add. </param>
        /// <param name="item2"> Second item of item to add. </param>
        public void Add( T1 item1, T2 item2 ){
            base.Add( TupleC.Create( item1, item2 ) );
        } // public void Add( T1 item1, T2 item2 )

        /// <summary>
        /// find item's index with binary search.
        /// ( just call base.BinarySearch( TupleC.Create( item1, item2 ) ) )
        /// </summary>
        ...
        public int IndexOf( T1 item1, T2 item2, int index, int count ){
            return base.IndexOf( TupleC.Create( item1, item2 ), index, count );
        } // public void IndexOf( T1 item1, T2 item2, int index, int count )

        /// <summary>
        /// insert item to list at index.
        /// ( just call base.Insert( index, TupleC.Create( item1, item2 ) ) )
        /// </summary>
        ...
        public void Insert( int index, T1 item1, T2 item2 ){
            base.Insert( index, TupleC.Create( item1, item2 ) );
        } // public void Insert( int index, T1 item1, T2 item2 )

        /// <summary>
        /// find item's index in list from last.
        /// ( just call base.LastIndexOf( TupleC.Create( item1, item2 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to insert. </param>
        /// <param name="item2"> Second item of item to insert. </param>
        /// <returns> index of item. </returns>
        public int LastIndexOf( T1 item1, T2 item2 ){
            return base.LastIndexOf( TupleC.Create( item1, item2 ) );
        } // public void LastIndexOf( T1 item1, T2 item2 )

        /// <summary>
        /// find item's index in list from last start with specific index.
        /// ( just call base.LastIndexOf( TupleC.Create( item1, item2 ), index ) )
        /// </summary>
        /// <param name="item1"> First item of item to insert. </param>
        /// <param name="item2"> Second item of item to insert. </param>
        /// <param name="index"> find item start with index. </param>
        ...
        public int LastIndexOf( T1 item1, T2 item2, int index ){
            return base.LastIndexOf( TupleC.Create( item1, item2 ), index );
        ...
        /// ( just call base.LastIndexOf( TupleC.Create( item1, item2 ), index, count ) )
        /// </summary>
        /// <param name="item1"> First item of item to insert. </param>
        /// <param name="item2"> Second item of item to insert. </param>
        /// <param name="index"> find item start with index. </param>
        ...
        public int LastIndexOf( T1 item1, T2 item2, int index, int count ){
            return base.LastIndexOf( TupleC.Create( item1, item2 ), index, count );
        } // public void LastIndexOf( T1 item1, T2 item2, int index, int count )

        /// <summary>
        /// remove first match item from list.
        /// ( just call base.Remove( TupleC.Create( item1, item2 ) ) )
        /// </summary>
        ...
        public bool Remove( T1 item1, T2 item2 ){
            return base.Remove( TupleC.Create( item1, item2 ) );
    ...
    /// <summary>
    /// List with three item. ( just inherit from List&lt;TupleC&lt;T1,T2,T3&gt;&gt; and provide some method to use. )
    /// </summary>
    /// <typeparam name="T1"> type of First item. </typeparam>
    /// <typeparam name="T2"> type of Second item. </typeparam>
    /// <typeparam name="T3"> type of Third item. </typeparam>
    public class List<T1,T2,T3> : List<TupleC<T1,T2,T3>> {
        ...
        /// </summary>
        /// <param name="collection"> The collection whose elements are copied to the new list. </param>
        public List( IEnumerable<TupleC<T1,T2,T3>> collection ) : base( collection ) { }

        /// <summary>
        /// Add item to list.
        /// ( just call base.Add( TupleC.Create( item1, item2, item3 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to add. </param>
        /// <param name="item2"> Second item of item to add. </param>
        /// <param name="item3"> Third item of item to add. </param>
        public void Add( T1 item1, T2 item2, T3 item3 ){
            base.Add( TupleC.Create( item1, item2, item3 ) );
        } // public void Add( T1 item1, T2 item2, T3 item3 )

        /// <summary>
        /// find item's index with binary search.
        /// ( just call base.BinarySearch( TupleC.Create( item1, item2, item3 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to find. </param>
        /// <param name="item2"> Second item of item to find. </param>
        ...
        public int BinarySearch( T1 item1, T2 item2, T3 item3 ){
            return base.BinarySearch( TupleC.Create( item1, item2, item3 ) );
        } // public void BinarySearch( T1 item1, T2 item2, T3 item3 )

        /// <summary>
        /// find is list has item.
        /// ( just call base.Contains( TupleC.Create( item1, item2, item3 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to find. </param>
        /// <param name="item2"> Second item of item to find. </param>
        /// <param name="item3"> Third item of item to find. </param>
        ...
        public bool Contains( T1 item1, T2 item2, T3 item3 ){
            return base.Contains( TupleC.Create( item1, item2, item3 ) );
        } // public void Contains( T1 item1, T2 item2, T3 item3 )

        /// <summary>
        /// find item's index in list.
        /// ( just call base.IndexOf( TupleC.Create( item1, item2, item3 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to find. </param>
        /// <param name="item2"> Second item of item to find. </param>
        /// <param name="item3"> Third item of item to find. </param>
        ...
        public int IndexOf( T1 item1, T2 item2, T3 item3 ){
            return base.IndexOf( TupleC.Create( item1, item2, item3 ) );
        } // public void IndexOf( T1 item1, T2 item2, T3 item3 )

        /// <summary>
        /// find item's index in list start with specific index.
        /// ( just call base.IndexOf( TupleC.Create( item1, item2, item3 ), index ) )
        /// </summary>
        /// <param name="item1"> First item of item to find. </param>
        /// <param name="item2"> Second item of item to find. </param>
        /// <param name="item3"> Third item of item to find. </param>
        ...
        public int IndexOf( T1 item1, T2 item2, T3 item3, int index ){
            return base.IndexOf( TupleC.Create( item1, item2, item3 ), index );
        } // public void IndexOf( T1 item1, T2 item2, T3 item3, int index )

        /// <summary>
        /// find item's index in list start with specific index and specific item num.
        /// ( just call base.IndexOf( TupleC.Create( item1, item2, item3 ), index, count ) )
        /// </summary>
        /// <param name="item1"> First item of item to find. </param>
        /// <param name="item2"> Second item of item to find. </param>
        /// <param name="item3"> Third item of item to find. </param>
        ...
        public int IndexOf( T1 item1, T2 item2, T3 item3, int index, int count ){
            return base.IndexOf( TupleC.Create( item1, item2, item3 ), index, count );
        } // public void IndexOf( T1 item1, T2 item2, T3 item3, int index, int count )

        /// <summary>
        /// insert item to list at index.
        /// ( just call base.Insert( index, TupleC.Create( item1, item2, item3 ) ) )
        /// </summary>
        /// <param name="index"> insert at index. </param>
        /// <param name="item1"> First item of item to insert. </param>
        /// <param name="item2"> Second item of item to insert. </param>
        ...
        public void Insert( int index, T1 item1, T2 item2, T3 item3 ){
            base.Insert( index, TupleC.Create( item1, item2, item3 ) );
        } // public void Insert( int index, T1 item1, T2 item2, T3 item3 )

        /// <summary>
        /// find item's index in list from last.
        /// ( just call base.LastIndexOf( TupleC.Create( item1, item2, item3 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to insert. </param>
        /// <param name="item2"> Second item of item to insert. </param>
        /// <param name="item3"> Third item of item to insert. </param>
        ...
        public int LastIndexOf( T1 item1, T2 item2, T3 item3 ){
            return base.LastIndexOf( TupleC.Create( item1, item2, item3 ) );
        } // public void LastIndexOf( T1 item1, T2 item2, T3 item3 )

        /// <summary>
        /// find item's index in list from last start with specific index.
        /// ( just call base.LastIndexOf( TupleC.Create( item1, item2, item3 ), index ) )
        /// </summary>
        /// <param name="item1"> First item of item to insert. </param>
        /// <param name="item2"> Second item of item to insert. </param>
        /// <param name="item3"> Third item of item to insert. </param>
        ...
        public int LastIndexOf( T1 item1, T2 item2, T3 item3, int index ){
            return base.LastIndexOf( TupleC.Create( item1, item2, item3 ), index );
        } // public void LastIndexOf( T1 item1, T2 item2, T3 item3, int index )

        /// <summary>
        /// find item's index in list from last start with specific index and specific item num.
        /// ( just call base.LastIndexOf( TupleC.Create( item1, item2, item3 ), index, count ) )
        /// </summary>
        /// <param name="item1"> First item of item to insert. </param>
        /// <param name="item2"> Second item of item to insert. </param>
        /// <param name="item3"> Third item of item to insert. </param>
        ...
        public int LastIndexOf( T1 item1, T2 item2, T3 item3, int index, int count ){
            return base.LastIndexOf( TupleC.Create( item1, item2, item3 ), index, count );
        } // public void LastIndexOf( T1 item1, T2 item2, T3 item3, int index, int count )

        /// <summary>
        /// remove first match item from list.
        /// ( just call base.Remove( TupleC.Create( item1, item2, item3 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to remove. </param>
        /// <param name="item2"> Second item of item to remove. </param>
        ...
        public bool Remove( T1 item1, T2 item2, T3 item3 ){
            return base.Remove( TupleC.Create( item1, item2, item3 ) );
    ...
    /// <summary>
    /// List with four item. ( just inherit from List&lt;TupleC&lt;T1,T2,T3,T4&gt;&gt; and provide some method to use. )
    /// </summary>
    /// <typeparam name="T1"> type of First item. </typeparam>
    /// <typeparam name="T2"> type of Second item. </typeparam>
    /// <typeparam name="T3"> type of Third item. </typeparam>
    /// <typeparam name="T4"> type of Fourth item. </typeparam>
    public class List<T1,T2,T3,T4> : List<TupleC<T1,T2,T3,T4>> {
        ...
        /// </summary>
        /// <param name="collection"> The collection whose elements are copied to the new list. </param>
        public List( IEnumerable<TupleC<T1,T2,T3,T4>> collection ) : base( collection ) { }

        /// <summary>
        /// Add item to list.
        /// ( just call base.Add( TupleC.Create( item1, item2, item3, item4 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to add. </param>
        /// <param name="item2"> Second item of item to add. </param>
        /// <param name="item3"> Third item of item to add. </param>
        ...
        public void Add( T1 item1, T2 item2, T3 item3, T4 item4 ){
            base.Add( TupleC.Create( item1, item2, item3, item4 ) );
        } // public void Add( T1 item1, T2 item2, T3 item3, T4 item4 )

        /// <summary>
        /// find item's index with binary search.
        /// ( just call base.BinarySearch( TupleC.Create( item1, item2, item3, item4 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to find. </param>
        /// <param name="item2"> Second item of item to find. </param>
        /// <param name="item3"> Third item of item to find. </param>
        ...
        public int BinarySearch( T1 item1, T2 item2, T3 item3, T4 item4 ){
            return base.BinarySearch( TupleC.Create( item1, item2, item3, item4 ) );
        } // public void BinarySearch( T1 item1, T2 item2, T3 item3, T4 item4 )

        /// <summary>
        /// find is list has item.
        /// ( just call base.Contains( TupleC.Create( item1, item2, item3, item4 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to find. </param>
        /// <param name="item2"> Second item of item to find. </param>
        /// <param name="item3"> Third item of item to find. </param>
        ...
        public bool Contains( T1 item1, T2 item2, T3 item3, T4 item4 ){
            return base.Contains( TupleC.Create( item1, item2, item3, item4 ) );
        } // public void Contains( T1 item1, T2 item2, T3 item3, T4 item4 )

        /// <summary>
        /// find item's index in list.
        /// ( just call base.IndexOf( TupleC.Create( item1, item2, item3, item4 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to find. </param>
        /// <param name="item2"> Second item of item to find. </param>
        /// <param name="item3"> Third item of item to find. </param>
        ...
        public int IndexOf( T1 item1, T2 item2, T3 item3, T4 item4 ){
            return base.IndexOf( TupleC.Create( item1, item2, item3, item4 ) );
        } // public void IndexOf( T1 item1, T2 item2, T3 item3, T4 item4 )

        /// <summary>
        /// find item's index in list start with specific index.
        /// ( just call base.IndexOf( TupleC.Create( item1, item2, item3, item4 ), index ) )
        /// </summary>
        /// <param name="item1"> First item of item to find. </param>
        /// <param name="item2"> Second item of item to find. </param>
        /// <param name="item3"> Third item of item to find. </param>
        ...
        public int IndexOf( T1 item1, T2 item2, T3 item3, T4 item4, int index ){
            return base.IndexOf( TupleC.Create( item1, item2, item3, item4 ), index );
        } // public void IndexOf( T1 item1, T2 item2, T3 item3, T4 item4, int index )

        /// <summary>
        /// find item's index in list start with specific index and specific item num.
        /// ( just call base.IndexOf( TupleC.Create( item1, item2, item3, item4 ), index, count ) )
        /// </summary>
        /// <param name="item1"> First item of item to find. </param>
        /// <param name="item2"> Second item of item to find. </param>
        /// <param name="item3"> Third item of item to find. </param>
        ...
        public int IndexOf( T1 item1, T2 item2, T3 item3, T4 item4, int index, int count ){
            return base.IndexOf( TupleC.Create( item1, item2, item3, item4 ), index, count );
        } // public void IndexOf( T1 item1, T2 item2, T3 item3, T4 item4, int index, int count )

        /// <summary>
        /// insert item to list at index.
        /// ( just call base.Insert( index, TupleC.Create( item1, item2, item3, item4 ) ) )
        /// </summary>
        /// <param name="index"> insert at index. </param>
        /// <param name="item1"> First item of item to insert. </param>
        /// <param name="item2"> Second item of item to insert. </param>
        ...
        public void Insert( int index, T1 item1, T2 item2, T3 item3, T4 item4 ){
            base.Insert( index, TupleC.Create( item1, item2, item3, item4 ) );
        } // public void Insert( int index, T1 item1, T2 item2, T3 item3, T4 item4 )

        /// <summary>
        /// find item's index in list from last.
        /// ( just call base.LastIndexOf( TupleC.Create( item1, item2, item3, item4 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to insert. </param>
        /// <param name="item2"> Second item of item to insert. </param>
        /// <param name="item3"> Third item of item to insert. </param>
        ...
        public int LastIndexOf( T1 item1, T2 item2, T3 item3, T4 item4 ){
            return base.LastIndexOf( TupleC.Create( item1, item2, item3, item4 ) );
        } // public void LastIndexOf( T1 item1, T2 item2, T3 item3, T4 item4 )

        /// <summary>
        /// find item's index in list from last start with specific index.
        /// ( just call base.LastIndexOf( TupleC.Create( item1, item2, item3, item4 ), index ) )
        /// </summary>
        /// <param name="item1"> First item of item to insert. </param>
        /// <param name="item2"> Second item of item to insert. </param>
        /// <param name="item3"> Third item of item to insert. </param>
        ...
        public int LastIndexOf( T1 item1, T2 item2, T3 item3, T4 item4, int index ){
            return base.LastIndexOf( TupleC.Create( item1, item2, item3, item4 ), index );
        } // public void LastIndexOf( T1 item1, T2 item2, T3 item3, T4 item4, int index )

        /// <summary>
        /// find item's index in list from last start with specific index and specific item num.
        /// ( just call base.LastIndexOf( TupleC.Create( item1, item2, item3, item4 ), index, count ) )
        /// </summary>
        /// <param name="item1"> First item of item to insert. </param>
        /// <param name="item2"> Second item of item to insert. </param>
        /// <param name="item3"> Third item of item to insert. </param>
        ...
        public int LastIndexOf( T1 item1, T2 item2, T3 item3, T4 item4, int index, int count ){
            return base.LastIndexOf( TupleC.Create( item1, item2, item3, item4 ), index, count );
        } // public void LastIndexOf( T1 item1, T2 item2, T3 item3, T4 item4, int index, int count )

        /// <summary>
        /// remove first match item from list.
        /// ( just call base.Remove( TupleC.Create( item1, item2, item3, item4 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to remove. </param>
        /// <param name="item2"> Second item of item to remove. </param>
        /// <param name="item3"> Third item of item to remove. </param>
        ...
        public bool Remove( T1 item1, T2 item2, T3 item3, T4 item4 ){
            return base.Remove( TupleC.Create( item1, item2, item3, item4 ) );
    ...
    /// <summary>
    /// List with five item. ( just inherit from List&lt;TupleC&lt;T1,T2,T3,T4,T5&gt;&gt; and provide some method to use. )
    /// </summary>
    /// <typeparam name="T1"> type of First item. </typeparam>
    /// <typeparam name="T2"> type of Second item. </typeparam>
    /// <typeparam name="T3"> type of Third item. </typeparam>
    ...
    public class List<T1,T2,T3,T4,T5> : List<TupleC<T1,T2,T3,T4,T5>> {
        ...
        /// </summary>
        /// <param name="collection"> The collection whose elements are copied to the new list. </param>
        public List( IEnumerable<TupleC<T1,T2,T3,T4,T5>> collection ) : base( collection ) { }

        /// <summary>
        /// Add item to list.
        /// ( just call base.Add( TupleC.Create( item1, item2, item3, item4, item5 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to add. </param>
        /// <param name="item2"> Second item of item to add. </param>
        /// <param name="item3"> Third item of item to add. </param>
        ...
        public void Add( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5 ){
            base.Add( TupleC.Create( item1, item2, item3, item4, item5 ) );
        } // public void Add( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5 )

        /// <summary>
        /// find item's index with binary search.
        /// ( just call base.BinarySearch( TupleC.Create( item1, item2, item3, item4, item5 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to find. </param>
        /// <param name="item2"> Second item of item to find. </param>
        /// <param name="item3"> Third item of item to find. </param>
        ...
        public int BinarySearch( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5 ){
            return base.BinarySearch( TupleC.Create( item1, item2, item3, item4, item5 ) );
        } // public void BinarySearch( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5 )

        /// <summary>
        /// find is list has item.
        /// ( just call base.Contains( TupleC.Create( item1, item2, item3, item4, item5 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to find. </param>
        /// <param name="item2"> Second item of item to find. </param>
        /// <param name="item3"> Third item of item to find. </param>
        ...
        public bool Contains( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5 ){
            return base.Contains( TupleC.Create( item1, item2, item3, item4, item5 ) );
        } // public void Contains( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5 )

        /// <summary>
        /// find item's index in list.
        /// ( just call base.IndexOf( TupleC.Create( item1, item2, item3, item4, item5 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to find. </param>
        /// <param name="item2"> Second item of item to find. </param>
        /// <param name="item3"> Third item of item to find. </param>
        ...
        public int IndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5 ){
            return base.IndexOf( TupleC.Create( item1, item2, item3, item4, item5 ) );
        } // public void IndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5 )

        /// <summary>
        /// find item's index in list start with specific index.
        /// ( just call base.IndexOf( TupleC.Create( item1, item2, item3, item4, item5 ), index ) )
        /// </summary>
        /// <param name="item1"> First item of item to find. </param>
        /// <param name="item2"> Second item of item to find. </param>
        /// <param name="item3"> Third item of item to find. </param>
        ...
        public int IndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, int index ){
            return base.IndexOf( TupleC.Create( item1, item2, item3, item4, item5 ), index );
        } // public void IndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, int index )

        /// <summary>
        /// find item's index in list start with specific index and specific item num.
        /// ( just call base.IndexOf( TupleC.Create( item1, item2, item3, item4, item5 ), index, count ) )
        /// </summary>
        /// <param name="item1"> First item of item to find. </param>
        /// <param name="item2"> Second item of item to find. </param>
        /// <param name="item3"> Third item of item to find. </param>
        ...
        public int IndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, int index, int count ){
            return base.IndexOf( TupleC.Create( item1, item2, item3, item4, item5 ), index, count );
        } // public void IndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, int index, int count )

        /// <summary>
        /// insert item to list at index.
        /// ( just call base.Insert( index, TupleC.Create( item1, item2, item3, item4, item5 ) ) )
        /// </summary>
        /// <param name="index"> insert at index. </param>
        /// <param name="item1"> First item of item to insert. </param>
        /// <param name="item2"> Second item of item to insert. </param>
        ...
        public void Insert( int index, T1 item1, T2 item2, T3 item3, T4 item4, T5 item5 ){
            base.Insert( index, TupleC.Create( item1, item2, item3, item4, item5 ) );
        } // public void Insert( int index, T1 item1, T2 item2, T3 item3, T4 item4, T5 item5 )

        /// <summary>
        /// find item's index in list from last.
        /// ( just call base.LastIndexOf( TupleC.Create( item1, item2, item3, item4, item5 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to insert. </param>
        /// <param name="item2"> Second item of item to insert. </param>
        /// <param name="item3"> Third item of item to insert. </param>
        ...
        public int LastIndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5 ){
            return base.LastIndexOf( TupleC.Create( item1, item2, item3, item4, item5 ) );
        } // public void LastIndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5 )

        /// <summary>
        /// find item's index in list from last start with specific index.
        /// ( just call base.LastIndexOf( TupleC.Create( item1, item2, item3, item4, item5 ), index ) )
        /// </summary>
        /// <param name="item1"> First item of item to insert. </param>
        /// <param name="item2"> Second item of item to insert. </param>
        /// <param name="item3"> Third item of item to insert. </param>
        ...
        public int LastIndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, int index ){
            return base.LastIndexOf( TupleC.Create( item1, item2, item3, item4, item5 ), index );
        } // public void LastIndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, int index )

        /// <summary>
        /// find item's index in list from last start with specific index and specific item num.
        /// ( just call base.LastIndexOf( TupleC.Create( item1, item2, item3, item4, item5 ), index, count ) )
        /// </summary>
        /// <param name="item1"> First item of item to insert. </param>
        /// <param name="item2"> Second item of item to insert. </param>
        /// <param name="item3"> Third item of item to insert. </param>
        ...
        public int LastIndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, int index, int count ){
            return base.LastIndexOf( TupleC.Create( item1, item2, item3, item4, item5 ), index, count );
        } // public void LastIndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, int index, int count )

        /// <summary>
        /// remove first match item from list.
        /// ( just call base.Remove( TupleC.Create( item1, item2, item3, item4, item5 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to remove. </param>
        /// <param name="item2"> Second item of item to remove. </param>
        /// <param name="item3"> Third item of item to remove. </param>
        ...
        public bool Remove( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5 ){
            return base.Remove( TupleC.Create( item1, item2, item3, item4, item5 ) );
    ...
    /// <summary>
    /// List with six item. ( just inherit from List&lt;TupleC&lt;T1,T2,T3,T4,T5,T6&gt;&gt; and provide some method to use. )
    /// </summary>
    /// <typeparam name="T1"> type of First item. </typeparam>
    /// <typeparam name="T2"> type of Second item. </typeparam>
    /// <typeparam name="T3"> type of Third item. </typeparam>
    ...
    public class List<T1,T2,T3,T4,T5,T6> : List<TupleC<T1,T2,T3,T4,T5,T6>> {
        ...
        /// </summary>
        /// <param name="collection"> The collection whose elements are copied to the new list. </param>
        public List( IEnumerable<TupleC<T1,T2,T3,T4,T5,T6>> collection ) : base( collection ) { }

        /// <summary>
        /// Add item to list.
        /// ( just call base.Add( TupleC.Create( item1, item2, item3, item4, item5, item6 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to add. </param>
        /// <param name="item2"> Second item of item to add. </param>
        /// <param name="item3"> Third item of item to add. </param>
        ...
        public void Add( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6 ){
            base.Add( TupleC.Create( item1, item2, item3, item4, item5, item6 ) );
        } // public void Add( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6 )

        /// <summary>
        /// find item's index with binary search.
        /// ( just call base.BinarySearch( TupleC.Create( item1, item2, item3, item4, item5, item6 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to find. </param>
        /// <param name="item2"> Second item of item to find. </param>
        /// <param name="item3"> Third item of item to find. </param>
        ...
        public int BinarySearch( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6 ){
            return base.BinarySearch( TupleC.Create( item1, item2, item3, item4, item5, item6 ) );
        } // public void BinarySearch( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6 )

        /// <summary>
        /// find is list has item.
        /// ( just call base.Contains( TupleC.Create( item1, item2, item3, item4, item5, item6 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to find. </param>
        /// <param name="item2"> Second item of item to find. </param>
        /// <param name="item3"> Third item of item to find. </param>
        ...
        public bool Contains( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6 ){
            return base.Contains( TupleC.Create( item1, item2, item3, item4, item5, item6 ) );
        } // public void Contains( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6 )

        /// <summary>
        /// find item's index in list.
        /// ( just call base.IndexOf( TupleC.Create( item1, item2, item3, item4, item5, item6 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to find. </param>
        /// <param name="item2"> Second item of item to find. </param>
        /// <param name="item3"> Third item of item to find. </param>
        ...
        public int IndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6 ){
            return base.IndexOf( TupleC.Create( item1, item2, item3, item4, item5, item6 ) );
        } // public void IndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6 )

        /// <summary>
        /// find item's index in list start with specific index.
        /// ( just call base.IndexOf( TupleC.Create( item1, item2, item3, item4, item5, item6 ), index ) )
        /// </summary>
        /// <param name="item1"> First item of item to find. </param>
        /// <param name="item2"> Second item of item to find. </param>
        /// <param name="item3"> Third item of item to find. </param>
        ...
        public int IndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, int index ){
            return base.IndexOf( TupleC.Create( item1, item2, item3, item4, item5, item6 ), index );
        } // public void IndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, int index )

        /// <summary>
        /// find item's index in list start with specific index and specific item num.
        /// ( just call base.IndexOf( TupleC.Create( item1, item2, item3, item4, item5, item6 ), index, count ) )
        /// </summary>
        /// <param name="item1"> First item of item to find. </param>
        /// <param name="item2"> Second item of item to find. </param>
        /// <param name="item3"> Third item of item to find. </param>
        ...
        public int IndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, int index, int count ){
            return base.IndexOf( TupleC.Create( item1, item2, item3, item4, item5, item6 ), index, count );
        } // public void IndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, int index, int count )

        /// <summary>
        /// insert item to list at index.
        /// ( just call base.Insert( index, TupleC.Create( item1, item2, item3, item4, item5, item6 ) ) )
        /// </summary>
        /// <param name="index"> insert at index. </param>
        /// <param name="item1"> First item of item to insert. </param>
        /// <param name="item2"> Second item of item to insert. </param>
        ...
        public void Insert( int index, T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6 ){
            base.Insert( index, TupleC.Create( item1, item2, item3, item4, item5, item6 ) );
        } // public void Insert( int index, T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6 )

        /// <summary>
        /// find item's index in list from last.
        /// ( just call base.LastIndexOf( TupleC.Create( item1, item2, item3, item4, item5, item6 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to insert. </param>
        /// <param name="item2"> Second item of item to insert. </param>
        /// <param name="item3"> Third item of item to insert. </param>
        ...
        public int LastIndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6 ){
            return base.LastIndexOf( TupleC.Create( item1, item2, item3, item4, item5, item6 ) );
        } // public void LastIndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6 )

        /// <summary>
        /// find item's index in list from last start with specific index.
        /// ( just call base.LastIndexOf( TupleC.Create( item1, item2, item3, item4, item5, item6 ), index ) )
        /// </summary>
        /// <param name="item1"> First item of item to insert. </param>
        /// <param name="item2"> Second item of item to insert. </param>
        /// <param name="item3"> Third item of item to insert. </param>
        ...
        public int LastIndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, int index ){
            return base.LastIndexOf( TupleC.Create( item1, item2, item3, item4, item5, item6 ), index );
        } // public void LastIndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, int index )

        /// <summary>
        /// find item's index in list from last start with specific index and specific item num.
        /// ( just call base.LastIndexOf( TupleC.Create( item1, item2, item3, item4, item5, item6 ), index, count ) )
        /// </summary>
        /// <param name="item1"> First item of item to insert. </param>
        /// <param name="item2"> Second item of item to insert. </param>
        /// <param name="item3"> Third item of item to insert. </param>
        ...
        public int LastIndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, int index, int count ){
            return base.LastIndexOf( TupleC.Create( item1, item2, item3, item4, item5, item6 ), index, count );
        } // public void LastIndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, int index, int count )

        /// <summary>
        /// remove first match item from list.
        /// ( just call base.Remove( TupleC.Create( item1, item2, item3, item4, item5, item6 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to remove. </param>
        /// <param name="item2"> Second item of item to remove. </param>
        /// <param name="item3"> Third item of item to remove. </param>
        ...
        public bool Remove( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6 ){
            return base.Remove( TupleC.Create( item1, item2, item3, item4, item5, item6 ) );
    ...
    /// <summary>
    /// List with seven item. ( just inherit from List&lt;TupleC&lt;T1,T2,T3,T4,T5,T6,T7&gt;&gt; and provide some method to use. )
    /// </summary>
    /// <typeparam name="T1"> type of First item. </typeparam>
    /// <typeparam name="T2"> type of Second item. </typeparam>
    /// <typeparam name="T3"> type of Third item. </typeparam>
    ...
    public class List<T1,T2,T3,T4,T5,T6,T7> : List<TupleC<T1,T2,T3,T4,T5,T6,T7>> {
        ...
        /// </summary>
        /// <param name="collection"> The collection whose elements are copied to the new list. </param>
        public List( IEnumerable<TupleC<T1,T2,T3,T4,T5,T6,T7>> collection ) : base( collection ) { }

        /// <summary>
        /// Add item to list.
        /// ( just call base.Add( TupleC.Create( item1, item2, item3, item4, item5, item6, item7 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to add. </param>
        /// <param name="item2"> Second item of item to add. </param>
        /// <param name="item3"> Third item of item to add. </param>
        ...
        public void Add( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7 ){
            base.Add( TupleC.Create( item1, item2, item3, item4, item5, item6, item7 ) );
        } // public void Add( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7 )

        /// <summary>
        /// find item's index with binary search.
        /// ( just call base.BinarySearch( TupleC.Create( item1, item2, item3, item4, item5, item6, item7 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to find. </param>
        /// <param name="item2"> Second item of item to find. </param>
        /// <param name="item3"> Third item of item to find. </param>
        ...
        public int BinarySearch( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7 ){
            return base.BinarySearch( TupleC.Create( item1, item2, item3, item4, item5, item6, item7 ) );
        } // public void BinarySearch( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7 )

        /// <summary>
        /// find is list has item.
        /// ( just call base.Contains( TupleC.Create( item1, item2, item3, item4, item5, item6, item7 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to find. </param>
        /// <param name="item2"> Second item of item to find. </param>
        /// <param name="item3"> Third item of item to find. </param>
        ...
        public bool Contains( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7 ){
            return base.Contains( TupleC.Create( item1, item2, item3, item4, item5, item6, item7 ) );
        } // public void Contains( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7 )

        /// <summary>
        /// find item's index in list.
        /// ( just call base.IndexOf( TupleC.Create( item1, item2, item3, item4, item5, item6, item7 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to find. </param>
        /// <param name="item2"> Second item of item to find. </param>
        /// <param name="item3"> Third item of item to find. </param>
        ...
        public int IndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7 ){
            return base.IndexOf( TupleC.Create( item1, item2, item3, item4, item5, item6, item7 ) );
        } // public void IndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7 )

        /// <summary>
        /// find item's index in list start with specific index.
        /// ( just call base.IndexOf( TupleC.Create( item1, item2, item3, item4, item5, item6, item7 ), index ) )
        /// </summary>
        /// <param name="item1"> First item of item to find. </param>
        /// <param name="item2"> Second item of item to find. </param>
        /// <param name="item3"> Third item of item to find. </param>
        ...
        public int IndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7, int index ){
            return base.IndexOf( TupleC.Create( item1, item2, item3, item4, item5, item6, item7 ), index );
        } // public void IndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7, int index )

        /// <summary>
        /// find item's index in list start with specific index and specific item num.
        /// ( just call base.IndexOf( TupleC.Create( item1, item2, item3, item4, item5, item6, item7 ), index, count ) )
        /// </summary>
        /// <param name="item1"> First item of item to find. </param>
        /// <param name="item2"> Second item of item to find. </param>
        /// <param name="item3"> Third item of item to find. </param>
        ...
        public int IndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7, int index, int count ){
            return base.IndexOf( TupleC.Create( item1, item2, item3, item4, item5, item6, item7 ), index, count );
        } // public void IndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7, int index, int count )

        /// <summary>
        /// insert item to list at index.
        /// ( just call base.Insert( index, TupleC.Create( item1, item2, item3, item4, item5, item6, item7 ) ) )
        /// </summary>
        /// <param name="index"> insert at index. </param>
        /// <param name="item1"> First item of item to insert. </param>
        /// <param name="item2"> Second item of item to insert. </param>
        ...
        public void Insert( int index, T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7 ){
            base.Insert( index, TupleC.Create( item1, item2, item3, item4, item5, item6, item7 ) );
        } // public void Insert( int index, T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7 )

        /// <summary>
        /// find item's index in list from last.
        /// ( just call base.LastIndexOf( TupleC.Create( item1, item2, item3, item4, item5, item6, item7 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to insert. </param>
        /// <param name="item2"> Second item of item to insert. </param>
        /// <param name="item3"> Third item of item to insert. </param>
        ...
        public int LastIndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7 ){
            return base.LastIndexOf( TupleC.Create( item1, item2, item3, item4, item5, item6, item7 ) );
        } // public void LastIndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7 )

        /// <summary>
        /// find item's index in list from last start with specific index.
        /// ( just call base.LastIndexOf( TupleC.Create( item1, item2, item3, item4, item5, item6, item7 ), index ) )
        /// </summary>
        /// <param name="item1"> First item of item to insert. </param>
        /// <param name="item2"> Second item of item to insert. </param>
        /// <param name="item3"> Third item of item to insert. </param>
        ...
        public int LastIndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7, int index ){
            return base.LastIndexOf( TupleC.Create( item1, item2, item3, item4, item5, item6, item7 ), index );
        } // public void LastIndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7, int index )

        /// <summary>
        /// find item's index in list from last start with specific index and specific item num.
        /// ( just call base.LastIndexOf( TupleC.Create( item1, item2, item3, item4, item5, item6, item7 ), index, count ) )
        /// </summary>
        /// <param name="item1"> First item of item to insert. </param>
        /// <param name="item2"> Second item of item to insert. </param>
        /// <param name="item3"> Third item of item to insert. </param>
        ...
        public int LastIndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7, int index, int count ){
            return base.LastIndexOf( TupleC.Create( item1, item2, item3, item4, item5, item6, item7 ), index, count );
        } // public void LastIndexOf( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7, int index, int count )

        /// <summary>
        /// remove first match item from list.
        /// ( just call base.Remove( TupleC.Create( item1, item2, item3, item4, item5, item6, item7 ) ) )
        /// </summary>
        /// <param name="item1"> First item of item to remove. </param>
        /// <param name="item2"> Second item of item to remove. </param>
        /// <param name="item3"> Third item of item to remove. </param>
        ...
        public bool Remove( T1 item1, T2 item2, T3 item3, T4 item4, T5 item5, T6 item6, T7 item7 ){
            return base.Remove( TupleC.Create( item1, item2, item3, item4, item5, item6, item7 ) );
