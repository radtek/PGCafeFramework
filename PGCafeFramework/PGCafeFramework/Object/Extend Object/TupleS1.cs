...
namespace PGCafe.Object {
    ...
    public static class TupleS {
        ...
        public static TupleS<T1,T2,T3,T4,T5,T6,T7,T8> Create<T1,T2,T3,T4,T5,T6,T7,T8>( T1 Item1, T2 Item2, T3 Item3, T4 Item4, T5 Item5, T6 Item6, T7 Item7, T8 Item8 ) {
            return new TupleS<T1,T2,T3,T4,T5,T6,T7,T8>( Item1, Item2, Item3, Item4, Item5, Item6, Item7, Item8 );
        } // public static TupleS<T1,T2,T3,T4,T5,T6,T7,T8> Create<T1,T2,T3,T4,T5,T6,T7,T8>( T1 Item1, T2 Item2, T3 Item3, T4 Item4, T5 Item5, T6 Item6, T7 Item7, T8 Item8 )

     } // public static class TupleS

    /// <summary>
    /// Tuple with two item ( struct Type, and item is writeable
    /// </summary>
    /// <typeparam name="T1"> type of First item. </typeparam>
    /// <typeparam name="T2"> type of Second item. </typeparam>
    public struct TupleS<T1,T2> {
        ...
        /// <summary> Create Struct Tuple by two Item. </summary>
        /// <param name="Item1"> First item </param>
        /// <param name="Item2"> Second item </param>
    ...
    /// <summary>
    /// Tuple with three item ( struct Type, and item is writeable
    /// </summary>
    /// <typeparam name="T1"> type of First item. </typeparam>
    /// <typeparam name="T2"> type of Second item. </typeparam>
    /// <typeparam name="T3"> type of Third item. </typeparam>
    public struct TupleS<T1,T2,T3> {
        private readonly T1 mItem1;
        private readonly T2 mItem2;
        ...
        /// <summary> Create Struct Tuple by three Item. </summary>
        /// <param name="Item1"> First item </param>
        /// <param name="Item2"> Second item </param>
        /// <param name="Item3"> Third item </param>
    ...
    /// <summary>
    /// Tuple with four item ( struct Type, and item is writeable
    /// </summary>
    /// <typeparam name="T1"> type of First item. </typeparam>
    /// <typeparam name="T2"> type of Second item. </typeparam>
    /// <typeparam name="T3"> type of Third item. </typeparam>
    /// <typeparam name="T4"> type of Fourth item. </typeparam>
    public struct TupleS<T1,T2,T3,T4> {
        private readonly T1 mItem1;
        private readonly T2 mItem2;
        private readonly T3 mItem3;
        ...
        /// <summary> Create Struct Tuple by four Item. </summary>
        /// <param name="Item1"> First item </param>
        /// <param name="Item2"> Second item </param>
        /// <param name="Item3"> Third item </param>
        /// <param name="Item4"> Fourth item </param>
    ...
    /// <summary>
    /// Tuple with five item ( struct Type, and item is writeable
    /// </summary>
    /// <typeparam name="T1"> type of First item. </typeparam>
    /// <typeparam name="T2"> type of Second item. </typeparam>
    /// <typeparam name="T3"> type of Third item. </typeparam>
    /// <typeparam name="T4"> type of Fourth item. </typeparam>
    /// <typeparam name="T5"> type of Fifth item. </typeparam>
    public struct TupleS<T1,T2,T3,T4,T5> {
        private readonly T1 mItem1;
        private readonly T2 mItem2;
        private readonly T3 mItem3;
        private readonly T4 mItem4;
        ...
        /// <summary> Create Struct Tuple by five Item. </summary>
        /// <param name="Item1"> First item </param>
        /// <param name="Item2"> Second item </param>
        /// <param name="Item3"> Third item </param>
        /// <param name="Item4"> Fourth item </param>
    ...
    /// <summary>
    /// Tuple with six item ( struct Type, and item is writeable
    /// </summary>
    /// <typeparam name="T1"> type of First item. </typeparam>
    /// <typeparam name="T2"> type of Second item. </typeparam>
    /// <typeparam name="T3"> type of Third item. </typeparam>
    ...
    /// <typeparam name="T5"> type of Fifth item. </typeparam>
    /// <typeparam name="T6"> type of Sixth item. </typeparam>
    public struct TupleS<T1,T2,T3,T4,T5,T6> {
        private readonly T1 mItem1;
        private readonly T2 mItem2;
        private readonly T3 mItem3;
        private readonly T4 mItem4;
        ...
        /// <summary> Create Struct Tuple by six Item. </summary>
        /// <param name="Item1"> First item </param>
        /// <param name="Item2"> Second item </param>
        /// <param name="Item3"> Third item </param>
        /// <param name="Item4"> Fourth item </param>
    ...
    /// <summary>
    /// Tuple with seven item ( struct Type, and item is writeable
    /// </summary>
    /// <typeparam name="T1"> type of First item. </typeparam>
    /// <typeparam name="T2"> type of Second item. </typeparam>
    /// <typeparam name="T3"> type of Third item. </typeparam>
    ...
    /// <typeparam name="T6"> type of Sixth item. </typeparam>
    /// <typeparam name="T7"> type of Seventh item. </typeparam>
    public struct TupleS<T1,T2,T3,T4,T5,T6,T7> {
        private readonly T1 mItem1;
        private readonly T2 mItem2;
        private readonly T3 mItem3;
        private readonly T4 mItem4;
        ...
        /// <summary> Create Struct Tuple by seven Item. </summary>
        /// <param name="Item1"> First item </param>
        /// <param name="Item2"> Second item </param>
        /// <param name="Item3"> Third item </param>
        /// <param name="Item4"> Fourth item </param>
    ...
    /// <summary>
    /// Tuple with eight item ( struct Type, and item is writeable
    /// </summary>
    /// <typeparam name="T1"> type of First item. </typeparam>
    /// <typeparam name="T2"> type of Second item. </typeparam>
    /// <typeparam name="T3"> type of Third item. </typeparam>
    ...
    /// <typeparam name="T7"> type of Seventh item. </typeparam>
    /// <typeparam name="T8"> type of Eighth item. </typeparam>
    public struct TupleS<T1,T2,T3,T4,T5,T6,T7,T8> {
        private readonly T1 mItem1;
        private readonly T2 mItem2;
        private readonly T3 mItem3;
        private readonly T4 mItem4;
        ...
        /// <summary> Create Struct Tuple by eight Item. </summary>
        /// <param name="Item1"> First item </param>
        /// <param name="Item2"> Second item </param>
        /// <param name="Item3"> Third item </param>
        /// <param name="Item4"> Fourth item </param>
        ...
        /// <param name="Item7"> Seventh item </param>
        /// <param name="Item8"> Eighth item </param>
        public TupleS( T1 Item1, T2 Item2, T3 Item3, T4 Item4, T5 Item5, T6 Item6, T7 Item7, T8 Item8 ){
            this.mItem1 = Item1;
            this.mItem2 = Item2;
            this.mItem3 = Item3;
            this.mItem4 = Item4;
